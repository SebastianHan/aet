...
class PhaseReportCommand extends BaseCommand {
  async execute(options) {
    ...
    try {
      ...
      if (!owner || !repository) {
        throw new Error('Missing required configuration. Please ensure you are running the script in a project directory that contains .aet/config.json with "owner" and "repository" configured.');
      }
