...
description: Requirements Analysis - structures raw requirements into specifications via Socratic dialogue
metadata:
  pattern: pipeline
  stages: 2
...
Transform RR (GitHub Issues, product requirements, verbal descriptions, etc.) into a structured requirements specification (IR).
...
| **Maintain Boundaries** | Focus exclusively on requirements clarification and boundary definition. | ❌ make design decisions |
