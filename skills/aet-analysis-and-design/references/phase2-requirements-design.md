...
description: Requirements Design - decomposes requirements into SR-AR architecture design
metadata:
  pattern: pipeline
  stages: 3
...
Based on the requirements analysis specification (IR), complete the architecture change design and SR-AR decomposition, producing the **Requirements Design Specification**. This provides a clear technical blueprint for subsequent development planning and code implementation.
